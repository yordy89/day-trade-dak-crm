...
import { CustomersFilters } from '@/components/academy/customer/customers-filters';
import { CustomersTable } from '@/components/academy/customer/customers-table';
import type { Customer } from '@/components/academy/customer/customers-table';

export const metadata = { title: `Customers | Academy | ${config.site.name}` } satisfies Metadata;
