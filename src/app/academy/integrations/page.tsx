...
import { IntegrationCard } from '@/components/academy/integrations/integrations-card';
import type { Integration } from '@/components/academy/integrations/integrations-card';
import { CompaniesFilters } from '@/components/academy/integrations/integrations-filters';

export const metadata = { title: `Integrations | Academy | ${config.site.name}` } satisfies Metadata;
