...
const books: Book[] = [
  ...
  },
  {
    ...
    rating: 4.5,
    price: '$50.33',
    amazonLink: 'https://www.amazon.com/Los-magos-del-mercado/dp/8494276840/ref=sr_1_1?crid=37ZIBW270ZP4V&dib=eyJ2IjoiMSJ9.a4O8Z-L39OOz-6k66okht-d-UM6lKnwiIDtsktxecYiwtdFnGZHnO6keME9HudZiQqMf8nE2q64C_2vbvZlfMgwy9zyTjh70OciUjla8pdgM_4rsWQsvOCBFlBWzoRowCZcnTCg9nOmM5HcO3adk6BVks3tBB1CWrzhnvVO-IU2Zv2zZ2TycP66V1ZjTyPzkQRHiRXwHJUnWZWV2PftNNrDk8YrR9kFlhMHQ_Nz8yhs.0cX9rx-TXmjreCIaOtepbXjeXKofPyd9SUKk8VGocmk&dib_tag=se&keywords=los+magos+del+mercado&qid=1741470914&sprefix=Los+magos%2Caps%2C143&sr=8-1',
  },
  {
  ...
  },
  {
    ...
    rating: 4.6,
    price: '$14.39',
    amazonLink: 'https://www.amazon.com/Solo-una-cosa-Thing-Spanish/dp/6071136962/ref=sr_1_1?crid=288MKM7X0CYQO&dib=eyJ2IjoiMSJ9.PlBCuhojOa8scnc2ypgobPe2m-2u7mKZpvx1XZ8nhobDz-IrW521wCcWC4uhrlGiWiB-BnMHIaxaUjNN3c3_54mroJBavSU5VIOjnDi28RQ.4D0iWKJQJWR4ZzfHufC-vpQVIw6zMCWOsMEnEAcYSm8&dib_tag=se&keywords=solo+una+cosa+libro+espa%C3%B1ol&qid=1741471215&sprefix=Solo+una+cosa%2Caps%2C120&sr=8-1',
  },
  {
                    ...
                    <Box sx={{ p: 6, height: '100%', display: 'flex', flexDirection: 'column' }}>
                      ...
                      <Box sx={{ mb: 4 }}>
                        <Grid container spacing={2}>
                          {[
                            { icon: <TrendingUp />, text: i18n.language === 'es' ? 'Estrategias Probadas' : 'Proven Strategies' },
                            { icon: <Psychology />, text: i18n.language === 'es' ? 'Mentalidad Ganadora' : 'Winning Mindset' },
                            { icon: <CheckCircle />, text: i18n.language === 'es' ? 'Casos Reales' : 'Real Cases' },
                          ].map((benefit, index) => (
